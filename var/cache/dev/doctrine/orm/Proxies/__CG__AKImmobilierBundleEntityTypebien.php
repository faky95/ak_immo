 ...
 */
class Typebien extends \AK\ImmobilierBundle\Entity\Typebien implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AK\\ImmobilierBundle\\Entity\\Typebien' . "\0" . 'id', '' . "\0" . 'AK\\ImmobilierBundle\\Entity\\Typebien' . "\0" . 'libelle', '' . "\0" . 'AK\\ImmobilierBundle\\Entity\\Typebien' . "\0" . 'biens'];
        }
